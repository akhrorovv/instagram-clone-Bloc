...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  _dialogRemovePost(Post post, List<Post> posts) async {
    ...
    if (result) {
      ...
      DBService.removePost(post)
          .then((value) => {profileBloc.add(LoadProfilePostsEvent(posts))});
    }
  }
  ...
  void initState() {
    ...
    _apiLoadMember();
    // _apiLoadPosts();
    profileBloc.add(LoadProfilePostsEvent(profileBloc.items));
  }
